...
import { XyteCustom } from "./client-custom";

export class Xyte extends XyteCustom {
  ...
  constructor(configurationParameters: ConfigurationParameters) {
    ...
    this.ticket = new TicketApi(configuration);
  }
