...
import { DeviceGetConfigResponseConfigNetwork } from './device-get-config-response-config-network';
import { DeviceGetConfigResponseConfigOther } from './device-get-config-response-config-other';

/**
 * 
 * @export
 * @interface DeviceGetConfigResponseConfig
 */
export interface DeviceGetConfigResponseConfig {
    /**
     * 
     * @type {DeviceGetConfigResponseConfigNetwork}
     * @memberof DeviceGetConfigResponseConfig
     */
    'network'?: DeviceGetConfigResponseConfigNetwork;
    /**
     * 
     * @type {DeviceGetConfigResponseConfigOther}
     * @memberof DeviceGetConfigResponseConfig
     */
    'other'?: DeviceGetConfigResponseConfigOther;
}
