...
import { FirmwareVersionCannotBeBlank } from './firmware-version-cannot-be-blank';
import { NanoIdHasAlreadyBeenTaken } from './nano-id-has-already-been-taken';
import { SerialNumberHasAlreadyBeenTaken } from './serial-number-has-already-been-taken';

/**
 * @type DeviceCreateRegistration422Response
 * @export
 */
export type DeviceCreateRegistration422Response = FirmwareVersionCannotBeBlank | NanoIdHasAlreadyBeenTaken | SerialNumberHasAlreadyBeenTaken;
