 ...
 * 
 * @export
 * @interface DeviceOpenIncidentRequest
 */
export interface DeviceOpenIncidentRequest {
    /**
     * Short title
     * @type {string}
     * @memberof DeviceOpenIncidentRequest
     */
    'title': string;
    /**
     * 
     ...
     * @memberof DeviceOpenIncidentRequest
     */
    'priority'?: DeviceOpenIncidentRequestPriorityEnum;
    /**
...
type DeviceOpenIncidentRequestPriorityEnum = '1' | '2' | '3' | '4' | '5'
