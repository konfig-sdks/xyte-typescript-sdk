 ...
 * 
 * @export
 * @interface DeviceListDevicesResponseDataInnerModel
 */
export interface DeviceListDevicesResponseDataInnerModel {
    /**
     * 
     * @type {string}
     * @memberof DeviceListDevicesResponseDataInnerModel
     */
    'id'?: string;
    /**
     * 
