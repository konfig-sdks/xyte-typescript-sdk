 ...
 * 
 * @export
 * @interface DeviceGetSpaceInfoResponseLocationCoordinates
 */
export interface DeviceGetSpaceInfoResponseLocationCoordinates {
    /**
     * 
     * @type {number}
     * @memberof DeviceGetSpaceInfoResponseLocationCoordinates
     */
    'lat'?: number;
    /**
     * 
