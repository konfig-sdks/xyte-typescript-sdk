...
import { DeviceListCommandsResponseDataInner } from './device-list-commands-response-data-inner';
import { DeviceListCommandsResponsePageInfo } from './device-list-commands-response-page-info';

/**
 * 
 * @export
 * @interface DeviceListCommandsResponse
 */
export interface DeviceListCommandsResponse {
    /**
     * 
     * @type {Array<DeviceListCommandsResponseDataInner>}
     * @memberof DeviceListCommandsResponse
     */
    'data'?: Array<DeviceListCommandsResponseDataInner>;
    /**
     * 
     * @type {DeviceListCommandsResponsePageInfo}
     * @memberof DeviceListCommandsResponse
     */
    'page_info'?: DeviceListCommandsResponsePageInfo;
}
