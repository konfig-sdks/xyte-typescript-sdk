 ...
 * 
 * @export
 * @interface DeviceGetAllDeviceStateHistories401Response
 */
export interface DeviceGetAllDeviceStateHistories401Response {
    /**
     * 
     * @type {string}
     * @memberof DeviceGetAllDeviceStateHistories401Response
     */
    'error'?: string;
}
