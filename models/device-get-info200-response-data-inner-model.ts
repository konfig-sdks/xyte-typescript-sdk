 ...
 * 
 * @export
 * @interface DeviceGetInfo200ResponseDataInnerModel
 */
export interface DeviceGetInfo200ResponseDataInnerModel {
    /**
     * 
     * @type {string}
     * @memberof DeviceGetInfo200ResponseDataInnerModel
     */
    'id'?: string;
    /**
     * 
