 ...
 * 
 * @export
 * @interface DeviceListDevicesResponseDataInnerFirmware
 */
export interface DeviceListDevicesResponseDataInnerFirmware {
    /**
     * 
     * @type {string}
     * @memberof DeviceListDevicesResponseDataInnerFirmware
     */
    'version'?: string;
}
