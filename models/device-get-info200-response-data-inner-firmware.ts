 ...
 * 
 * @export
 * @interface DeviceGetInfo200ResponseDataInnerFirmware
 */
export interface DeviceGetInfo200ResponseDataInnerFirmware {
    /**
     * 
     * @type {string}
     * @memberof DeviceGetInfo200ResponseDataInnerFirmware
     */
    'version'?: string;
}
