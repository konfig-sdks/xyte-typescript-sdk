...
import { DeviceGetInfoResponseConfig } from './device-get-info-response-config';
import { DeviceGetInfoResponseCustom } from './device-get-info-response-custom';
import { DeviceGetInfoResponsePartner } from './device-get-info-response-partner';
import { DeviceGetInfoResponseState } from './device-get-info-response-state';

/**
 * 
 * @export
 * @interface DeviceGetInfoResponse
 */
export interface DeviceGetInfoResponse {
    /**
     * 
     * @type {string}
     * @memberof DeviceGetInfoResponse
     */
    'id'?: string;
    /**
     * 
     * @type {DeviceGetInfoResponsePartner}
     * @memberof DeviceGetInfoResponse
     */
    'partner'?: DeviceGetInfoResponsePartner;
    /**
     * 
     * @type {DeviceGetInfoResponseConfig}
     * @memberof DeviceGetInfoResponse
     */
    'config'?: DeviceGetInfoResponseConfig;
    /**
     * 
     * @type {DeviceGetInfoResponseState}
     * @memberof DeviceGetInfoResponse
     */
    'state'?: DeviceGetInfoResponseState;
    /**
     * 
     * @type {string}
     * @memberof DeviceGetInfoResponse
