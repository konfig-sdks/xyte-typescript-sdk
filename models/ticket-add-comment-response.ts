...
import { TicketAddCommentResponseCommentsInner } from './ticket-add-comment-response-comments-inner';

/**
 * 
 * @export
 * @interface TicketAddCommentResponse
 */
export interface TicketAddCommentResponse {
    /**
     * 
     * @type {string}
     * @memberof TicketAddCommentResponse
     */
    'title'?: string;
    /**
     * 
    ...
    /**
     * 
     * @type {Array<TicketAddCommentResponseCommentsInner>}
     * @memberof TicketAddCommentResponse
     */
    'comments'?: Array<TicketAddCommentResponseCommentsInner>;
}
