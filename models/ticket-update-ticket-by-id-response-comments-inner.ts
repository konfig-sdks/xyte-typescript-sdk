 ...
 * 
 * @export
 * @interface TicketUpdateTicketByIdResponseCommentsInner
 */
export interface TicketUpdateTicketByIdResponseCommentsInner {
    /**
     * 
     * @type {number}
     * @memberof TicketUpdateTicketByIdResponseCommentsInner
     */
    'id'?: number;
    /**
     * 
