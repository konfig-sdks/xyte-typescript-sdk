...
import { TicketCloseResponseCommentsInner } from './ticket-close-response-comments-inner';

/**
 * 
 * @export
 * @interface TicketCloseResponse
 */
export interface TicketCloseResponse {
    /**
     * 
     * @type {string}
     * @memberof TicketCloseResponse
     */
    'title'?: string;
    /**
     * 
    ...
    /**
     * 
     * @type {Array<TicketCloseResponseCommentsInner>}
     * @memberof TicketCloseResponse
     */
    'comments'?: Array<TicketCloseResponseCommentsInner>;
}
