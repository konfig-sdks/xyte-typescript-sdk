...
import { DeviceGetSpaceInfoResponseLocation } from './device-get-space-info-response-location';

/**
 * 
 * @export
 * @interface DeviceGetSpaceInfoResponse
 */
export interface DeviceGetSpaceInfoResponse {
    /**
     * 
     * @type {DeviceGetSpaceInfoResponseLocation}
     * @memberof DeviceGetSpaceInfoResponse
     */
    'location'?: DeviceGetSpaceInfoResponseLocation;
    /**
     * 
     * @type {string}
     * @memberof DeviceGetSpaceInfoResponse
