...
import { TicketGetByIdResponseCommentsInner } from './ticket-get-by-id-response-comments-inner';

/**
 * 
 * @export
 * @interface TicketGetByIdResponse
 */
export interface TicketGetByIdResponse {
    /**
     * 
     * @type {string}
     * @memberof TicketGetByIdResponse
     */
    'title'?: string;
    /**
     * 
    ...
    /**
     * 
     * @type {Array<TicketGetByIdResponseCommentsInner>}
     * @memberof TicketGetByIdResponse
     */
    'comments'?: Array<TicketGetByIdResponseCommentsInner>;
}
