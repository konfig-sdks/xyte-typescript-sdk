...
import { DeviceGetSpaceInfoResponseLocationCoordinates } from './device-get-space-info-response-location-coordinates';

/**
 * 
 * @export
 * @interface DeviceGetSpaceInfoResponseLocation
 */
export interface DeviceGetSpaceInfoResponseLocation {
    /**
     * 
     * @type {DeviceGetSpaceInfoResponseLocationCoordinates}
     * @memberof DeviceGetSpaceInfoResponseLocation
     */
    'coordinates'?: DeviceGetSpaceInfoResponseLocationCoordinates;
    /**
     * 
     * @type {number}
     * @memberof DeviceGetSpaceInfoResponseLocation
