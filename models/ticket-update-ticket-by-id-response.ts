...
import { TicketUpdateTicketByIdResponseCommentsInner } from './ticket-update-ticket-by-id-response-comments-inner';

/**
 * 
 * @export
 * @interface TicketUpdateTicketByIdResponse
 */
export interface TicketUpdateTicketByIdResponse {
    /**
     * 
     * @type {string}
     * @memberof TicketUpdateTicketByIdResponse
     */
    'title'?: string;
    /**
     * 
    ...
    /**
     * 
     * @type {Array<TicketUpdateTicketByIdResponseCommentsInner>}
     * @memberof TicketUpdateTicketByIdResponse
     */
    'comments'?: Array<TicketUpdateTicketByIdResponseCommentsInner>;
}
