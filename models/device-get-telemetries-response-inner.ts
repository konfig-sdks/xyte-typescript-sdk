...
import { DeviceGetTelemetriesResponseInnerTelemetries } from './device-get-telemetries-response-inner-telemetries';

/**
 * 
 * @export
 * @interface DeviceGetTelemetriesResponseInner
 */
export interface DeviceGetTelemetriesResponseInner {
    /**
     * 
     * @type {string}
     * @memberof DeviceGetTelemetriesResponseInner
     */
    'created_at'?: string;
    /**
     * 
    ...
    /**
     * 
     * @type {DeviceGetTelemetriesResponseInnerTelemetries}
     * @memberof DeviceGetTelemetriesResponseInner
     */
    'telemetries'?: DeviceGetTelemetriesResponseInnerTelemetries;
}
