...
import { DeviceListDevicesResponseDataInner } from './device-list-devices-response-data-inner';
import { DeviceListDevicesResponsePageInfo } from './device-list-devices-response-page-info';

/**
 * 
 * @export
 * @interface DeviceListDevicesResponse
 */
export interface DeviceListDevicesResponse {
    /**
     * 
     * @type {Array<DeviceListDevicesResponseDataInner>}
     * @memberof DeviceListDevicesResponse
     */
    'data'?: Array<DeviceListDevicesResponseDataInner>;
    /**
     * 
     * @type {DeviceListDevicesResponsePageInfo}
     * @memberof DeviceListDevicesResponse
     */
    'page_info'?: DeviceListDevicesResponsePageInfo;
}
